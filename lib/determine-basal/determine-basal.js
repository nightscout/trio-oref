...
//    var sensitivityRatio;
    ...
    if (profile.temptargetSet && target_bg < normalTarget && chrisFormula && BG >= target_bg) {
    ...
    if (sensitivityRatio && !chrisFormula) { // Disable adjustment of basal by sensitivityRatio when using dISF
